...
//
const AwsConsole = exports.AwsConsole = function (options) {
...
//
util.inherits(AwsConsole, Transport);

//
// Expose the name of this Transport on the prototype
//
AwsConsole.prototype.name = 'awsConsole'
...
//
AwsConsole.prototype.log = function (level, msg, meta, callback) {
  if (this.silent) {
