...
exports.init = function init(provider) {
  pg.types.setTypeParser(PgTypeOids.TIMESTAMP, makeTimestampToUtcMomentParser(provider.logger))
  ...
  const config = {
    ...
    connectionTimeoutMillis: provider.getConfigVal('DB_CLIENT_CONNECT_TIMEOUT', 5000),
    Promise,
  }
