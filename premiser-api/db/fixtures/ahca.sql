...
insert into writ_quotes (writ_quote_id, citation_id, created, quote) values
...
select setval('writ_quotes_writ_quote_id_seq', (select max(writ_quote_id) from writ_quotes));
...
(6, 1, 'STATEMENT', 1, 'WRIT_QUOTE', 1, 'NEGATIVE', NOW()),
