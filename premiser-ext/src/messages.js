...
export const runCommandsWhenTabReloaded =
  (commands) => ({type: RUN_COMMANDS_WHEN_TAB_RELOADED, payload: {commands}})

export const RUN_COMMANDS = "RUN_COMMANDS"
export const runCommands = (commands) => ({type: RUN_COMMANDS, payload: {commands}})
