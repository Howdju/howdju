...
violates this Code of Conduct, please report it using the provided functionality, or email
...
<EmailAddress username="legal" /> that comply with the Digital Millennium Copyright
Act ("DMCA").
