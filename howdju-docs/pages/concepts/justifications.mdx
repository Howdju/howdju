...
A Justification's <Feature issueId="692">Strength</Feature> indicates the weight
that the Justification creator or someone voting on it attributes to its basis
to
