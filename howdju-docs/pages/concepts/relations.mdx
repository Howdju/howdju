...
Howdju has not implemented relations yet, but the first two are likely to be
`PropositionEquivalence` and `JustificationEquivalence`. Howdju will use these relations to
display different entities in a combined way.
