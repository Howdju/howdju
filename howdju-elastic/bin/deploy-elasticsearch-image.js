...
const s3ReposityKeyId =
  credentials.premiser.elasticsearch_s3_snapshots_user.aws_access_key_id;
const s3RepositorySecretKey =
  credentials.premiser.elasticsearch_s3_snapshots_user.aws_secret_access_key;

const command =
  `bin/deploy_component_image.sh ${component} ${args.version}` +
