...
_e.utcNowIsAfter = (dateTimeString) =>
  _e.utcNow().isAfter(moment.utc(dateTimeString));
...
_e.arrayToObject = (items, itemKey = null) =>
  reduce(
    items,
    (acc, item) => {
      if (itemKey) {
...
_e.encodeQueryStringObject = (obj) =>
