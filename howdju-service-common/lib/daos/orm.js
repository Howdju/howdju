...
const toJustification = makeMapper(function toJustificationMapper(
  ...
  const justification = {
    ...
    rootTarget: mapRelation(
      justificationRootTargetMapperByType[row.root_target_type],
      "root_target_",
      row
    ),
...
const toPropositionCompoundAtom = (row) =>
  row && {
...
const toJustificationScore = (row) =>
  row && {
    justificationId: row.justification_id,
...
const toRegistrationRequest = makeMapper(function toRegistrationRequestMapper(
  row
) {
  return {
...
const toPasswordResetRequest = makeMapper(function toPasswordResetRequestMapper(
  row
) {
  return {
