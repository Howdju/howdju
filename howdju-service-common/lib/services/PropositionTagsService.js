...
exports.PropositionTagsService = class PropositionTagsService {
  ...
  readRecommendedTagsForPropositionId(propositionId) {
    return this.propositionTagsDao.readRecommendedTagsForPropositionId(propositionId)
  }
  ...
  readTaggedPropositionsByVotePolarityAsUser(userId, tagId) {
    return this.propositionTagsDao.readTaggedPropositionsByVotePolarityAsUser(userId, tagId)
  }
}