...
export const envHtmlWebpackPluginConfig =
  process.env.NODE_ENV === "development"
    ? devHtmlWebpackPluginConfig
    : prodHtmlWebpackPluginConfig;
export const envDefinePluginConfig =
  process.env.NODE_ENV === "development"
    ? devDefinePluginConfig
    : prodDefinePluginConfig;
export const envWebpackConfig =
  process.env.NODE_ENV === "development" ? devWebpackConfig : prodWebpackConfig;
