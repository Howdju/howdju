...
const modelErrorMessages = {
  ...
  [entityConflictCodes.ANOTHER_TEXTUAL_SOURCE_QUOTE_HAS_SAME_QUOTE]: 'That quote from that source already exists',
  [entityConflictCodes.ANOTHER_TEXTUAL_SOURCE_HAS_EQUIVALENT_TEXT]: 'That source already exists',
  ...
  [userActionsConflictCodes.OTHER_USERS_HAVE_BASED_JUSTIFICATIONS_ON_THIS_TEXTUAL_SOURCE_QUOTE]:
    'Other users have already based justifications on this quote',
  [userActionsConflictCodes.OTHER_USERS_HAVE_BASED_JUSTIFICATIONS_ON_THIS_TEXTUAL_SOURCE]:
  ...
  [userActionsConflictCodes.OTHER_USERS_HAVE_VOTED_ON_JUSTIFICATIONS_BASED_ON_THIS_TEXTUAL_SOURCE_QUOTE]:
    'Other users have already voted on justifications using this quote',
  [userActionsConflictCodes.OTHER_USERS_HAVE_VOTED_ON_JUSTIFICATIONS_BASED_ON_THIS_TEXTUAL_SOURCE]:
    'Other users have already verified justification based on this source',
  [userActionsConflictCodes.OTHER_USERS_HAVE_COUNTERED_JUSTIFICATIONS_BASED_ON_THIS_TEXTUAL_SOURCE_QUOTE]:
    'Other users have already countered justifications based on this quote',
  [userActionsConflictCodes.OTHER_USERS_HAVE_COUNTERED_JUSTIFICATIONS_BASED_ON_THIS_TEXTUAL_SOURCE]:
