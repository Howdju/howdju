...
const modelErrorMessages = {
  ...
  [entityConflictCodes.ANOTHER_WRITING_QUOTE_HAS_EQUIVALENT_QUOTE_TEXT]: 'That quote from that source already exists',
  [entityConflictCodes.ANOTHER_WRITING_HAS_EQUIVALENT_TITLE]: 'That source already exists',
  ...
  [userActionsConflictCodes.OTHER_USERS_HAVE_BASED_JUSTIFICATIONS_ON_THIS_WRITING_QUOTE]:
    'Other users have already based justifications on this quote',
  [userActionsConflictCodes.OTHER_USERS_HAVE_BASED_JUSTIFICATIONS_ON_THIS_WRITING]:
  ...
  [userActionsConflictCodes.OTHER_USERS_HAVE_VOTED_ON_JUSTIFICATIONS_BASED_ON_THIS_WRITING_QUOTE]:
    'Other users have already voted on justifications using this quote',
  [userActionsConflictCodes.OTHER_USERS_HAVE_VOTED_ON_JUSTIFICATIONS_BASED_ON_THIS_WRITING]:
    'Other users have already verified justification based on this source',
  [userActionsConflictCodes.OTHER_USERS_HAVE_COUNTERED_JUSTIFICATIONS_BASED_ON_THIS_WRITING_QUOTE]:
    'Other users have already countered justifications based on this quote',
  [userActionsConflictCodes.OTHER_USERS_HAVE_COUNTERED_JUSTIFICATIONS_BASED_ON_THIS_WRITING]:
