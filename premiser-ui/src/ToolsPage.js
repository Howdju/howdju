  ...
  return (
    <div className="md-grid">
      ...
      <div className="md-cell md-cell--12">
        <h2>Bookmarklet</h2>
        <p>
          Use this bookmarklet to submit selected text on any page as a new
          quote justification.
        </p>
        <Button
          raised
        ...
        />
        <p></p>
        <p>Raw bookmarklet code for copy/paste:</p>
        <textarea value={bookmarkletHref} readOnly></textarea>
      </div>
    </div>
  );
};
