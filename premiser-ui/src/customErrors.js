...
export const newNetworkFailureError = (message, identifiers, sourceError) =>
    newCustomError(customErrorTypes.NETWORK_FAILURE_ERROR, makeIdentifiersMessage(message, identifiers), sourceError, {
      ...identifiers,
      url: sourceError.config.url,
    })

export const newApiResponseError = (message, identifiers, sourceError) =>
    newCustomError(customErrorTypes.API_RESPONSE_ERROR, makeIdentifiersMessage(message, identifiers), sourceError, {
      ...identifiers,
...
export const newRequestConfigurationError = (message, identifiers, sourceError) =>
    newCustomError(customErrorTypes.REQUEST_CONFIGURATION_ERROR, makeIdentifiersMessage(message, identifiers), sourceError, {
      ...identifiers,
