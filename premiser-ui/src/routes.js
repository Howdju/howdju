...
import CreatePropositionPage, {
  CreatePropositionPageMode,
} from "./CreatePropositionPage";
...
const renderHomePath = (props) => {
  ...
  return mainSearchText ? <MainSearchPage {...props} /> : <LandingPage />;
};
...
const routes = [
  ...
  <Route
    key="persorg"
    exact
    path="/persorgs/:persorgId/:slug?"
    component={PersorgPage}
  />,
  <Route key="tag" exact path="/tags/:tagId/:tagSlug?" component={TagPage} />,
  <Route
    key="searchJustifications"
    exact
    path="/search-justifications"
    component={JustificationsSearchPage}
  />,
  <Route
    key="proposition-usages"
    exact
    path="/proposition-usages"
    component={PropositionUsagesPage}
  />,

  <Route
    key="submitSourceExcerpt"
    exact
    path="/submit-source-excerpt"
    render={(props) => <SubmitSourceExcerptPage {...props} />}
  />,
  <Route
  ...
  />,
  <Route
    key="submitJustificationViaQueryString"
    exact
    path="/submit"
    render={(props) => (
      <CreatePropositionPage
...
export const routesById = reduce(
  routes,
  (result, route) => {
