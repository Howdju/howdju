...
export const selectIsWindowNarrow = (state: RootState) => state.app.isWindowNarrow
...
export const selectAuthTokenExpiration = (state: RootState) => state.auth.authTokenExpiration
